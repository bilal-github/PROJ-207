/**
 *
 * @description sends a GET request to retrieve Agents List from the database.
 * Requires the node.js use.get() function to retrieve data and send it back as a response.
